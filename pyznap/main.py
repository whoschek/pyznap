...
def _main():
    ...
    parser_send.add_argument('--send-properties', action="store_true",
                             dest='send_properties', help='include dataset properties in zfs send')
    ...
    try:
        ...
        if args.command == 'setup':
            ...
            if args.source and args.dest:
                ...
                # include dataset properties in zfs send
                send_properties = [args.send_properties] if args.send_properties else None
                ...
                send_config([{'name': args.source, 'dest': [args.dest], 'key': source_key,
                              ...
                              'send_last_snapshot': send_last_snapshot, 'send_properties': send_properties}])
